...
export const Inicio = () => {
  return (
    <section className='inicio before:contents(" ") flex h-[calc(100vh)] w-full flex-col items-center justify-center bg__home bg-cover bg-center px-5 text-center before:absolute before:bottom-0 before:h-32 before:w-full before:bg-gradient-to-t before:from-black before:to-transparent'>
