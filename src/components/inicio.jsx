...
export const Inicio = () => {
  return (
    <section className='inicio before:contents(" ") flex w-full flex-col items-center justify-center px-5 text-center before:absolute before:bottom-0 before:h-32 before:w-full before:bg-gradient-to-t before:from-black before:to-transparent'>
